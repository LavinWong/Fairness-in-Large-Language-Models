...
import numpy as np
from medium_sized.intrinsic_bias.probability_based.pseudo_log_likelihood_metrics.icat import data
...
def parse_file(gold_file, predictions_file):
    ...
    output_file = "medium_sized/intrinsic_bias/probability_based/pseudo_log_likelihood_metrics/icat/result.json"
