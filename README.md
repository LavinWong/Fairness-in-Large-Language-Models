...
**Intrinsic bias**: The inherent biases present in the output representation generated by a LM
...
**Extrinsic bias**: The disparity in a LM’s performance across different downstream tasks
* Classification
